//----------------------------------------------------------------------------------------------------;
var fileNm = "js-common/apis/validate/window.apis.validate.getCountryCDFromRequestKeyword__SYS0310.js";
 ...
 */
window.apis.validate.getCountryCDFromRequestKeyword__SYS0310 = function( str )
{
	window.RayLog.timeStamp( "---- [ S ] - " + "window.apis.validate.getCountryCDFromRequestKeyword__SYS0310():{null|uint}----------" );
	...
	window.RayLog.timeStamp( "---- [ E ] - " + "window.apis.validate.getCountryCDFromRequestKeyword__SYS0310():{null|uint}----------return 0;" );
