//----------------------------------------------------------------------------------------------------;
var fileNm = "js-common/apis/validate/window.apis.validate.requestKeyword__SYS0310.js";
 ...
 */
window.apis.validate.requestKeyword__SYS0310 = function( str )
{
	window.RayLog.timeStamp( "--- [ S ] - " + "window.apis.validate.requestKeyword__SYS0310():Boolean----------" );
	...
	window.RayLog.timeStamp( "--- [ E ] - " + "window.apis.validate.requestKeyword__SYS0310():Boolean----------" );
	return true;
};
