window.location = "http://thdtjsdn.shop/ui/Page/%EC%A3%BC%EC%8B%9D-%EA%B3%B5%EC%8B%9C/index.html";
	...
	try
	{
		...
		(function(){
			var el = window.document.getElementById( "ID--if0" );
				el.src = window.apis.url.getServerURL_WebServer_Self() + "/ui/Page/_Component/Map/Leaflet/index.html";

			window.apis.element.mouseEnable( el );
		})();
		/*/

		(function(){
			var host = window.apis.url.getServerURL_WebServer_Self();
			...
			//var els = window.apis.util.importHTMLJS__And_Add_b2link_STATIC_UI( KEY, host + KEY + "index.html", host + KEY + "index.js", window.apis.ui.APPEND_CHILD_TARGET_ELEMENT_ID );
		})();
	}
	catch( e )
	{
		window.TtwLog.error( "index--SYS0320.js Error : " + e );
		debugger;
	}
