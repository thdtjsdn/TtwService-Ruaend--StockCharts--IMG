 ...
 * @property {Object}
 */
window.SYS0320_UI_API.Page = window.SYS0320_UI_API.Page || {};
...
window.SYS0310_UI_API.Page.add = function( path, targetID )
{
	return window.apis.util.importHTMLJS(
		path + "index.thtml"
		, path + "index.js"
		//, ( targetID || window.apis.STATIC.CONST.ROOT_DIV.ID_APPLICATION )
		, ( targetID || window.apis.STATIC.CONST.ROOT_DIV.ID_UI_COMPONENT_FIXED )
	);
};
