//----------------------------------------------------------------------------------------------------;
var fileNm = "ui_js/SYS0320_UI_INTERFACE/__define/200_define_window.SYS0320_UI_INTERFACE.interface.js";
if( console ) console.log( "[ S ] - " + fileNm + "----------" );
//----------------------------------------------------------------------------------------------------;

//----------------------------------------------------------------------------------------------------[ S ] - window.SYS0320_UI_INTERFACE.interface;

window.SYS0320_UI_INTERFACE.interface = window.SYS0320_UI_INTERFACE.interface || {};

//----------------------------------------------------------------------------------------------------[ E ] - window.SYS0320_UI_INTERFACE.interface;
...
(function(){
	...
	/**
	 * _약속된 HTMLElement인 this.T.els.ROOT 통해 window.apis.event.DATA_LOAD_COMPLETE 이벤트를 Dispatch 시킨다.
	 * @function
	 * @param {Array|Object} eventDetail event.detail에 들어갈 Data
	 */
	var _dispatchCE__DATA_LOAD_COMPLETE = function( eventDetail ){ window.apis.event.dispatchCE__DATA_LOAD_COMPLETE( this.T.els.ROOT, eventDetail ); };

	/**
	 * _약속된 HTMLElement인 this.T.els.ROOT를 통해 window.apis.event.dispatchCE__DISPOSED_EL 이벤트를 Dispatch 시킨다.
	 * @function
	 * @param {Array|Object} eventDetail event.detail에 들어갈 Data
	 */
	//var _dispatchCE__DISPOSED_EL = function( eventDetail ){ window.apis.event.dispatchCE__DISPOSED_EL( this.T.els.ROOT, eventDetail ); };

	/**
	 * _약속된 HTMLElement인 this.T.els.ROOT를 통해 window.apis.event.dispatchCE__DISPOSED_JS 이벤트를 Dispatch 시킨다.
	 * @function
	 * @param {Array|Object} eventDetail event.detail에 들어갈 Data
	 */
	var _dispatchCE__DISPOSED_JS = function( eventDetail ){ window.apis.event.dispatchCE__DISPOSED_JS( this.T.els.ROOT, eventDetail ); };
	 ...
	 * @param {Array|Object} eventDetail event.detail에 들어갈 Data
	 */
	var _dispatchCE__INITIALIZED = function( eventDetail ){ window.apis.event.dispatchCE__INITIALIZED( this.T.els.ROOT, eventDetail ); };
	...
	/**
	 * window.apis.event.DATA_LOAD_COMPLETE 이벤트 타입의 이벤트 리스너를 this.T.els.ROOT에 1회 제거 후 추가한다;
	...
	var _addEvent__DATA_LOAD_COMPLETE = function( eventListener )
	{
		...
		this.T.els.ROOT.addEventListener( window.apis.event.DATA_LOAD_COMPLETE, eventListener, false, 0, true );
	};

	/**
	 * window.apis.event.DATA_LOAD_COMPLETE 이벤트 타입의 이벤트 리스너를 this.T.els.ROOT에 제거한다;
	 * @function
	 * @param {Function} function( event ){}
	 */
	var _removeEvent__DATA_LOAD_COMPLETE = function( eventListener )
	{
		...
		this.T.els.ROOT.removeEventListener( window.apis.event.DATA_LOAD_COMPLETE, eventListener, false, 0 );
	};

	/**
	 * window.apis.event.INITIALIZED 이벤트 타입의 이벤트 리스너를 this.T.els.ROOT에 1회 제거 후 추가한다;
	 * 동일한 Reference를 가지고 있는 eventListener은 중복 추가 되지 않게 처리 되어있다.
	 * @function
	 * @param {Function} function( event ){}
	 */
	var _addEvent__INITIALIZED = function( T, eventListener )
	{
		...
		T.addEventListener( window.apis.event.INITIALIZED, eventListener, false, 0, true );
	};

	/**
	 * window.apis.event.INITIALIZED 이벤트 타입의 이벤트 리스너를 this.T.els.ROOT에 제거한다;
	 * @function
	 * @param {Function} function( event ){}
	 */
	var _removeEvent__INITIALIZED = function( T, eventListener )
	{
		...
		T.removeEventListener( window.apis.event.INITIALIZED, eventListener, false, 0 );
	};
	...
	var _dispose = function()
	{
		...
		window.apis.event.dispatchCE__DISPOSED_EL( this.T.els.ROOT, this.T.els.ROOT );
		//----------마지막라인 에 필수 삽입;
	};
	 ...
	 * @return {Object}
	 */
	window.SYS0320_UI_INTERFACE.interface._COMMON_ = function( T )
	{
		var t = { T : T };
